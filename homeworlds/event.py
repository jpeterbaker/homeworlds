...
# These classes do most of the checking of the rules
...
class Creation(Event):
    ...
    def enact(self,state):
        if state.creationOver():
            raise LateCreationException('Homeworld creation only takes place on your first turn.')
...
######################################################################
# Elimination and Fade are non-optional side-effects of other events #
######################################################################
...
class Elimination(Event):
    ...
    def __init__(self,a,b):
        # a eliminated by b
        if a == b:
            raise SelfEliminationException('You may not abandon your homeworld')
        self.a = a
        self.b = b
    def enact(self,state):
    ...
    def __str__(self):
        return '(player {} is eliminated by {})'.format(self.a,self.b)

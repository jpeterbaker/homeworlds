...
text:'build b1 A',
quality:'',
comment:'<ul><li>You can use the power of Alti\'s star to build another blue ship.<br>1) Activate your blue ship.<br>2) Select the star of Alti to give your ship build power.<li>Good! You can use the power of the stars in *any* system where you have ships, even the stars of your opponent\'s homeworld (if you manage to get a ship there).<br>Now pass the token.</ul>',
img:'images/state13.png',
conts:[ {
text:'discover y1 Alien g1 B',
quality:'',
comment:'Your opponent has discovered a new system named "Bleb." It had to have a *small* star because your opponent\'s home is *only* connected to small stars (it has stars of the other two sizes).<br>Notice that Bleb *is* connected to Alti since their stars are different sizes.',
img:'images/state14.png',
conts:[ {
text:'move y1 Babamots A',
quality:'',
comment:'You\'ve learned to *discover* a new system, and it probably won\'t surprise you to learn that you can move ships between *existing* systems. Practice by moving your yellow ship to Alti.<br>1) Activate your yellow ship.<br>2) Select your yellow ship *again* to empower it with its own movement ability.<br>3) Select the Alti system as a destination.',
